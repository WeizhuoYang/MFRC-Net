"""
MFRCNet:Multi-Scale feature residual convolutional neural network for motor imagery decoding
@author: WeizhuoYang
"""
import torch
...
class MSconv(nn.Module):
    def __init__(self,in_chan,num_Feat):
        ...
        self.mixConv2d = nn.Sequential(
            MixedConv2d(in_channels=in_chan, out_channels=num_Feat, kernel_size=[(1,15),(1,25),(1,31),(1,125)],    # group
    ...
    def forward(self,x):
        ...
        x += self.mixConv2d(y)
        return x
## cross domain dual stream spatial convolution
class Resscb(nn.Module):
    ...
    def __init__(self,in_chan,num_Feat,dilatability,nChan):
        ...
        self.qm = nn.Sequential(
            MSconv(in_chan=9, num_Feat=num_Feat),
